...
(function () {
    if (window.CanvasRenderingContext2D) {
        ...
        c.svgCurve = function (I, H, K, A) {
            var B = this,
                G, F, C, D, E, z = function (y) {
                    return (G = I + y * K / p)
                },
                J = function (y) {
                    return (F = H + y * K / p)
                };
            E = A.replace(/ *([MZLHVCSQTA]) */gi, "|$1,").replace(/^\||\|[Z],/gi, "").split(/\|/);
            B.beginPath();
            for (C in E) {
                D = E[C].split(/[, ]/);
                (D[0] === "M") ? (B.moveTo(z(D[1]), J(D[2]))) : (D[0] === "L") ? (B.lineTo(z(D[1]), J(D[2]))) : (D[0] === "H") ? (B.lineTo(z(D[1]), F)) : (D[0] === "V") ? (B.lineTo(G, J(D[1]))) : (D[0] === "C") ? (B.bezierCurveTo(z(D[1]), J(D[2]), z(D[3]), J(D[4]), z(D[5]), J(D[6]))) : (D[0] === "Q") && (B.quadraticCurveTo(z(D[1]), J(D[2]), z(D[3]), J(D[4])))
            }
            B.closePath()
        };
